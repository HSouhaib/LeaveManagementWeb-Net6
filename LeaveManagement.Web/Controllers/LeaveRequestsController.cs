   ...
   public class LeaveRequestsController : Controller
   {
      ...
      public async Task<IActionResult> Create(LeaveRequestCreateVM model)
      {
         ...
         catch (Exception)
         {
            ...
            ModelState.AddModelError(string.Empty, " An Error Has Occured, Please Try AGAINE LATER.");
         }
      ...
      [HttpPost]
      [ValidateAntiForgeryToken]
      public async Task<IActionResult> Edit(int id, [Bind("StartDate,EndDate,LeaveTypeId,DateRequested,RequestComment,Approved,Cancelled,RequestingEmployeeeId,Id,DateCreated,DateModified")] LeaveRequest leaveRequest)
      {
